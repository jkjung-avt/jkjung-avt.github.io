...
Note that since OpenCV4Tegra and CUDA Toolkit were already installed on Jetson TX2 by JetPack-3.1, I did pay special attention not to re-install (which might actually cause problems) those with apt-get.
